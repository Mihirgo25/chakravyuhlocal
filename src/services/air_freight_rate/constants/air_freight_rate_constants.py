...
RATE_TYPES = ["market_place", "promotional", "consolidated", "cogo_assured", "general","non_tariff_rate"]
...
AIR_COVERAGE_USERS = [
    ...
    "763c56c3-4c7e-499f-9c65-1569269cbd2e",
    "1a0d178d-c2b9-473c-87e7-1ed0d750aff9",
    "038c43bf-9056-4398-8364-2241ad7ee0fa",
]
...
BREAK_EVEN_POINT_MAPPING = {
    'aa0e7e59-cbb9-43b2-98ce-1f992ae7ab19':['cd0a5a97-add6-4387-9966-1011ec465951']
}

CS_AIRLINES = ['e942211b-f46f-4a07-9756-626377218d1d']