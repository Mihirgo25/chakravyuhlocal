...
from services.air_freight_rate.interaction.delete_air_freight_rate_request import (
    delete_air_freight_rate_request,
)
from services.air_freight_rate.interaction.get_air_freight_storage_rate import (
    get_air_freight_storage_rate,
)
from services.air_freight_rate.interaction.delete_air_freight_rate_feedback import (
    delete_air_freight_rate_feedback,
)
from services.air_freight_rate.interaction.create_air_freight_rate import (
    create_air_freight_rate_data,
)
from services.air_freight_rate.interaction.list_air_freight_warehouse_rates import (
    list_air_freight_warehouse_rates,
)
from services.air_freight_rate.interaction.delete_air_freight_rate import (
    delete_air_freight_rate,
)
from services.air_freight_rate.interaction.update_air_freight_rate import (
    update_air_freight_rate,
)
from services.air_freight_rate.interaction.get_air_freight_rate import (
    get_air_freight_rate,
)
from services.air_freight_rate.interaction.list_air_freight_rate_surcharges import (
    list_air_freight_rate_surcharges,
)
from services.air_freight_rate.interaction.get_air_freight_rate_surcharge import (
    get_air_freight_rate_surcharge,
)
from services.air_freight_rate.interaction.create_air_freight_rate_surcharge import (
    create_air_freight_rate_surcharge,
)
from services.air_freight_rate.interaction.create_air_freight_rate_local import (
    create_air_freight_rate_local,
)
from services.air_freight_rate.interaction.update_air_freight_rate_surcharge import (
    update_air_freight_rate_surcharge,
)
from services.air_freight_rate.interaction.create_air_freight_rate_task import (
    create_air_freight_rate_task,
)
from services.air_freight_rate.interaction.get_air_freight_rate_local import (
    get_air_freight_rate_local,
)
from services.air_freight_rate.interaction.get_air_freight_rate_cards import (
    get_air_freight_rate_cards,
)
from services.air_freight_rate.interaction.update_air_freight_rate_local import (
    update_air_freight_rate_local,
)
from services.air_freight_rate.interaction.list_air_freight_rate_locals import (
    list_air_freight_rate_locals,
)
from services.air_freight_rate.interaction.update_air_freight_rate_task import (
    update_air_freight_rate_task_data,
)
from services.air_freight_rate.interaction.update_air_freight_rate_local import (
    update_air_freight_rate_local,
)
from services.air_freight_rate.interaction.create_air_freight_rate_request import (
    create_air_freight_rate_request,
)
from services.air_freight_rate.interaction.get_air_freight_rate_stats import (
    get_air_freight_rate_stats,
)
from services.air_freight_rate.interaction.create_air_freight_rate_not_available import (
    create_air_freight_rate_not_available,
)
from services.air_freight_rate.interaction.create_air_freight_storage_rate import (
    create_air_freight_storage_rate,
)
from services.air_freight_rate.interaction.get_air_freight_rate_visibility import (
    get_air_freight_rate_visibility,
)
from services.air_freight_rate.interaction.get_air_freight_rate_addition_frequency import (
    get_air_freight_rate_addition_frequency,
)
from services.air_freight_rate.interaction.get_air_freight_warehouse_rate import (
    get_air_freight_wareohouse_data,
)
from services.air_freight_rate.interaction.create_air_freight_warehouse_rate import (
    create_air_freight_warehouse_rate,
)
from services.air_freight_rate.interaction.update_air_freight_warehouse_rate import (
    update_air_freight_warehouse_rate,
)
from services.air_freight_rate.interaction.list_air_freight_rate_feedbacks import (
    list_air_freight_rate_feedbacks,
)
from services.air_freight_rate.interaction.list_air_freight_rate_requests import (
    list_air_freight_rate_requests,
)
from services.air_freight_rate.interaction.list_air_freight_rate_dislikes import (
    list_air_freight_rate_dislikes,
)
from services.air_freight_rate.interaction.list_air_freight_charge_codes import (
    list_air_freight_charge_codes,
)
from services.air_freight_rate.interaction.update_air_freight_rate_markup import (
    update_air_freight_rate_markup,
)
from services.air_freight_rate.interaction.list_air_freight_rates import (
    list_air_freight_rates,
)
from services.air_freight_rate.interaction.create_air_freight_rate_bulk_operation import (
    create_air_freight_rate_bulk_operation,
)
...
def get_air_freight_rate_addition_frequency_data(
    group_by: str, sort_type: str = "desc", resp: dict = Depends(authorize_token)
):
    if resp["status_code"] != 200:
        return JSONResponse(status_code=resp["status_code"], content=resp)
    request = {
    ...
    try:
        data = get_air_freight_rate_addition_frequency(request)
        data = jsonable_encoder(data)
        return JSONResponse(status_code=200, content=data)
    except HTTPException as e:
        raise
...
def list_air_freight_rate_surcharges_data(
    ...
    try:
        data = list_air_freight_rate_surcharges(
            filters, page_limit, page, pagination_data_required, return_query
        )
        return JSONResponse(status_code=200, content=jsonable_encoder(data))
    except HTTPException as e:
        raise
...
from services.air_freight_rate.interaction.update_air_freight_rate_request import (
    update_air_freight_rate_request,
)


@air_freight_router.post("update_air_freight_rate_request")
def update_air_freight_rate_request_data(
    request: UpdateAirFreightRateRequest, resp: dict = Depends(authorize_token)
):
    if resp["status_code"] != 200:
        return JSONResponse(status_code=resp["status_code"], content=resp)
    try:
...
def delete_air_freight_rate_request_data(
    request: DeleteAirFreightRateRequest, resp: dict = Depends(authorize_token)
):
    if resp["status_code"] != 200:
        return HTTPException(status_code=resp["status_code"], content=resp)
    try:
