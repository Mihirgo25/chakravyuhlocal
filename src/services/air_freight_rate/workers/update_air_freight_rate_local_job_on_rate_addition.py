...
from services.air_freight_rate.models.air_freight_rate_local_job_mapping import (
...
def update_air_freight_rate_local_job_on_rate_addition(request, id):
    ...
    exception_conditions = [(~AirFreightRateLocalJob.sources.contains(tag)) for tag in ['live_booking','rate_request','rate_feedback']]
