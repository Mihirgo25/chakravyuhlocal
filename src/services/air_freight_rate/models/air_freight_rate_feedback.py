...
class AirFreightRateFeedbacks(BaseModel):
    ...
    def supply_agents_notify(self):
        ...
        supply_agents_list=get_partner_users_by_expertise('air_freight',origin_locations,destination_locations)
        ...
        route = maps.list_locations({'filters':{'id': [str(locations_data.origin_airport_id), str(locations_data.destination_airport_id)]}})['list']
    ...
    def send_closed_notifications_to_sales_agent(self):
        ...
        location_pair_name=maps.list_locations({'filters':{'id':[str(locations_data.origin_airport_id),str(locations_data.destination_airport_id)]}})['list']
        ...
        destination_location = location_pair_name[str(locations_data.destination_airport_id)]
