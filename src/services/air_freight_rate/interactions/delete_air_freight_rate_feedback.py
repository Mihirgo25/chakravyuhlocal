...
from services.air_freight_rate.air_celery_worker import delete_jobs_for_air_freight_rate_feedback_delay
...
def execute_transaction_code(request):
    ...
    for obj in objects:
        ...
        delete_jobs_for_air_freight_rate_feedback_delay.apply_async(kwargs = {'requirements': request}, queue='fcl_freight_rate')    
