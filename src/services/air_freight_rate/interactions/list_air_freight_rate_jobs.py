...
def get_data(query, filters):
    ...
    for d in data:
        mappings_query = AirFreightRateJobMapping.select(AirFreightRateJobMapping.shipment_serial_id, AirFreightRateJobMapping.source_id, AirFreightRateJobMapping.shipment_id, AirFreightRateJobMapping.status).where(AirFreightRateJobMapping.job_id == d['id'])
