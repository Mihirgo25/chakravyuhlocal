...
def create_air_freight_rate_job(request, source):
    ...
    init_key = f'{str(params.get("origin_airport_id"))}:{str(params.get("destination_airport_id") or "")}:{str(params.get("airline_id"))}:{str(params.get("service_provider_id") or "")}:{str(params.get("commodity"))}:{str(params.get("rate_id"))}:{str(params.get("rate_type"))}:{str(params.get("commodity_type") or "")}:{str(params.get("commodity_sub_type") or "")}:{str(params.get("stacking_type") or "")}:{str(params.get("operation_type") or "")}'
