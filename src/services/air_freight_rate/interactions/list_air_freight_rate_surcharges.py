...
import json
from services.air_freight_rate.constants.air_freight_rate_constants import SURCHARGE_ELIGIBLE_LINE_ITEM_MAPPINGS
...
def get_eligible_charge_codes(surcharges):
    for surcharge in surcharges:
        ...
        if surcharge['origin_airport_id'] in SURCHARGE_ELIGIBLE_LINE_ITEM_MAPPINGS and surcharge['airline_id'] in SURCHARGE_ELIGIBLE_LINE_ITEM_MAPPINGS.get(surcharge['origin_airport_id']):
