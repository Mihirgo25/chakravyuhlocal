...
from services.air_freight_rate.constants.air_freight_rate_constants import AIR_STANDARD_VOLUMETRIC_WEIGHT_CONVERSION_RATIO,MAX_CARGO_LIMIT,DEFAULT_SERVICE_PROVIDER_ID, RATE_SOURCE_PRIORITIES, COGOXPRESS, SURCHARGE_ELIGIBLE_LINE_ITEMS_MAPPING, DEFAULT_APPLICABLE_LINE_ITEMS_MANUAL
