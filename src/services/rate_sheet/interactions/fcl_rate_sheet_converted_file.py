...
csv_options = {
    ...
    "skiprows": lambda x: x.startswith(
        ","
    ),  # use regex pattern in the skiprows parameter
}
        ...
        if valid_hash(row, present_field, blank_field):
            if rows:
                create_fcl_freight_freight_rate(
                    rows, created_by_id, procured_by_id, sourced_by_id
                )
                set_last_line(idx)
...
def set_original_file_path(params):
    ...
    with urllib.request.urlopen(params["file_url"], context=ssl_context) as response:
        with open(
            os.path.join("tmp", "rate_sheets", f"{params['id']}_original.csv"), "wb"
        ) as file:
...
def validate_fcl_freight_freight(params):
    ...
    last_line = get_last_line(params)
    rows = []
    # with open(get_file_path(params), 'r') as file:
    ...
    # CSV.foreach(get_original_file_path, headers: true, encoding: 'iso-8859-1:utf-8', quote_char: nil, skip_blanks: true, skip_lines: /^(?:,\s*)+$/) do |row|
    #         index += 1
    #         row = row.to_h.deep_symbolize_keys

    #         next if index < last_line

    #         if valid_hash?(row, [:origin_port, :destination_port, :container_size, :container_type, :commodity, :shipping_line, :validity_start, :validity_end, :code, :unit, :price, :currency], [:weight_free_limit, :weight_lower_limit, :weight_upper_limit, :weight_limit_price, :weight_limit_currency, :destination_detention_free_limit, :destination_detention_lower_limit, :destination_detention_upper_limit, :destination_detention_price, :destination_detention_currency])
    #           if rows.present?
    #             write_fcl_freight_freight_object(rows, csv)
    #             set_last_line(index)
    #           end
    #           rows = [row]

    #         elsif rows.present? &&
    #           (valid_hash?(row, [:code, :unit, :price, :currency], [:origin_port, :origin_main_port, :destination_port, :destination_main_port, :container_size, :container_type, :commodity, :shipping_line, :validity_start, :validity_end, :weight_free_limit, :weight_lower_limit, :weight_upper_limit, :weight_limit_price, :weight_limit_currency, :destination_detention_free_limit, :destination_detention_lower_limit, :destination_detention_upper_limit, :destination_detention_price, :destination_detention_currency]) ||
    #             valid_hash?(row, [:weight_free_limit], [:origin_port, :origin_main_port, :destination_port, :destination_main_port, :container_size, :container_type, :commodity, :shipping_line, :code, :unit, :price, :currency, :validity_start, :validity_end, :weight_lower_limit, :weight_upper_limit, :weight_limit_price, :weight_limit_currency, :destination_detention_free_limit, :destination_detention_lower_limit, :destination_detention_upper_limit, :destination_detention_price, :destination_detention_currency]) ||
    #             valid_hash?(row, [:weight_free_limit, :weight_lower_limit, :weight_upper_limit, :weight_limit_price, :weight_limit_currency], [:origin_port, :origin_main_port, :destination_port, :destination_main_port, :container_size, :container_type, :commodity, :shipping_line, :code, :unit, :price, :currency, :validity_start, :validity_end, :destination_detention_free_limit, :destination_detention_lower_limit, :destination_detention_upper_limit, :destination_detention_price, :destination_detention_currency]) ||
    #             valid_hash?(row, [:weight_lower_limit, :weight_upper_limit, :weight_limit_price, :weight_limit_currency], [:origin_port, :origin_main_port, :destination_port, :destination_main_port, :container_size, :container_type, :commodity, :shipping_line, :code, :unit, :price, :currency, :validity_start, :validity_end, :weight_free_limit, :destination_detention_free_limit, :destination_detention_lower_limit, :destination_detention_upper_limit, :destination_detention_price, :destination_detention_currency]) ||
    #             valid_hash?(row, [:destination_detention_free_limit], [:origin_port, :origin_main_port, :destination_port, :destination_main_port, :container_size, :container_type, :commodity, :shipping_line, :code, :unit, :price, :currency, :validity_start, :validity_end, :weight_free_limit, :weight_lower_limit, :weight_upper_limit, :weight_limit_price, :weight_limit_currency, :destination_detention_lower_limit, :destination_detention_upper_limit, :destination_detention_price, :destination_detention_currency]) ||
    #             valid_hash?(row, [:destination_detention_free_limit, :destination_detention_lower_limit, :destination_detention_upper_limit, :destination_detention_price, :destination_detention_currency], [:origin_port, :origin_main_port, :destination_port, :destination_main_port, :container_size, :container_type, :commodity, :shipping_line, :code, :unit, :price, :currency, :validity_start, :validity_end, :weight_free_limit, :weight_lower_limit, :weight_upper_limit, :weight_limit_price, :weight_limit_currency]) ||
    #             valid_hash?(row, [:destination_detention_lower_limit, :destination_detention_upper_limit, :destination_detention_price, :destination_detention_currency], [:origin_port, :origin_main_port, :destination_port, :destination_main_port, :container_size, :container_type, :commodity, :shipping_line, :code, :unit, :price, :currency, :validity_start, :validity_end, :weight_free_limit, :weight_lower_limit, :weight_upper_limit, :weight_limit_price, :weight_limit_currency, :destination_detention_free_limit]))
    #           rows << row
    #         else
    #           if rows.present?
    #             write_fcl_freight_freight_object(rows, csv)
    #             set_last_line(index)
    #           end
    #           csv << (row.values + ['Incorrect Row'])
    #           set_errors_present(true)
    #           set_last_line(index + 1)
    #           rows = []
    #         end
    #       end
    ...
    #     self.status = errors_present ? 'invalidated' : 'validated'

    #     self.file_url = UploadMediaToDigitalOcean.run!(file_path: get_file_path.to_s)[:uploaded_file_path]
    #   end
