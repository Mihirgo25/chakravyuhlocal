...
class FclFreightRate(BaseModel):
    ...
    def set_validities(self, validity_start, validity_end, line_items, schedule_type, deleted, payment_term, gri_tag = None, other_params={}):
        new_validities = []
        new_tags = {}
        ...
        for validity_object in self.validities:
            ...
            line_item = [t for t in validity_object['line_items'] if t['code'] == other_params['line_item_code']]
