...
from configs.fcl_freight_rate_constants import CONTAINER_SIZES, CONTAINER_TYPES, DEFAULT_RATE_TYPE
from configs.definitions import FCL_FREIGHT_SEASONAL_CHARGES
