...
class ClusterExtensionGriWorker(BaseModel):
    ...
    min_decrease_amount =FloatField(null=True)
    max_increase_amount = FloatField(null=True)
    min_decrease_percent =FloatField(null=True)
    max_increase_percent = FloatField(null=True)
