...
class FclWeightSlabsConfiguration(BaseModel):
    ...
    def validate_origin_location_id(self):
        ...
        location_data = maps.list_locations({'id':self.origin_location_id})['list']
    ...
    def validate_destination_location_id(self):
        ...
        location_data = maps.list_locations({'id':self.destination_location_id})['list']
        if len(location_data) == 0:
            raise HTTPException(status_code=400, detail="Invalid location ID")
    ...
    def validate_shipping_line_id(self):
        ...
        shipping_line_data = common.list_operators({'id':self.shipping_line_id})['list']
    ...
    def validate_service_provider_id(self):
        ...
        service_provider_data = organization.list_organizations({'id':self.service_provider_id})['list']
    ...
    def validate_importer_exporter_id(self):
        ...
        importer_exporter_data = organization.list_organizations({'id':self.importer_exporter_id})['list']
