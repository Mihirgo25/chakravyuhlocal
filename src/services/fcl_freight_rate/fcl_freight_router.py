...
def create_fcl_freight_rate_local_data(request: PostFclFreightRateLocal):
...
def update_fcl_freight_rate(request: UpdateFclFreightRate):
    rate = update_fcl_freight_rate_data(request.dict(exclude_none=True))
    return JSONResponse(status_code=200, content={"success": True})

@fcl_freight_router.put("/update_fcl_freight_rate_local")
def update_fcl_freight_rate_local_data(request: UpdateFclFreightRateLocal):
...
def delete_fcl_freight_rates(request: DeleteFclFreightRate):
...
def delete_fcl_freight_rates_request(request: DeleteFclFreightRateRequest):
...
def delete_fcl_freight_rates_feedback(request: DeleteFclFreightRateFeedback):
...
def delete_fcl_freight_rates_local_request(request: DeleteFclFreightRateLocalRequest):
...
def delete_fcl_freight_rates_local(request: DeleteFclFreightRateLocal):
...
def delete_fcl_freight_rates_free_day_request(request: DeleteFclFreightRateFreeDayRequest):
...
@fcl_freight_router.put("/update_fcl_freight_rate_free_day")
...
@fcl_freight_router.put('/update_fcl_freight_commodity_cluster')
def update_fcl_freight_commodity_cluster_data(request:UpdateFclFreightCommodityCluster):
    try:
...
@fcl_freight_router.put('/update_fcl_freight_commodity_surcharge')
