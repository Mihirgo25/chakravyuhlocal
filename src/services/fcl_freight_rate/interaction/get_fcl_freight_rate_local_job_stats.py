...
def build_weekly_details(query, statistics):
    ...
    weekly_stats_query = query.select(
        ...
        FclFreightRateLocalJob.status, FclFreightRateLocalJob.created_at.cast("date")
    )
