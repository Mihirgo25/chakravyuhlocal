...
def get_fcl_freight_predicted_rate(request, key):
    ...
    request['origin_country_id'] = port_id_country_id_dict[request['origin_port_id']]
    request['destination_country_id'] = port_id_country_id_dict[request['destination_port_id']]
   
    ports_distance = port_distance(location_dict[request['origin_port_id']],location_dict[request['destination_port_id']])
    origin_country_id = port_id_country_id_dict[request['origin_port_id']]
    destination_country_id = port_id_country_id_dict[request['destination_port_id']]
