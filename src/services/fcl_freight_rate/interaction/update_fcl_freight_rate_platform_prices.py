...
def update_fcl_freight_rate_platform_prices(request):
    ...
    FclFreightRate.origin_main_port_id == request['origin_main_port_id'] if request['origin_main_port_id'] else (FclFreightRate.id.is_null(False)),
    FclFreightRate.destination_port_id == request['destination_port_id'],
    FclFreightRate.destination_main_port_id == request['destination_main_port_id'] if request['destination_main_port_id'] else (FclFreightRate.id.is_null(False)),
    ...
    FclFreightRate.importer_exporter_id == request['importer_exporter_id'] if request['importer_exporter_id'] else (FclFreightRate.importer_exporter_id.is_null(True)),
