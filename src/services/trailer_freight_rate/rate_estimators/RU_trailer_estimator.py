...
class RUTrailerRateEstimator():
    ...
    def RU_estimate(self, container_size, container_type, containers_count, cargo_weight_per_container, trip_type):
        ''' 
        Primary Function to estimate Russian prices
        '''
        print('Estimating Russian rates')
