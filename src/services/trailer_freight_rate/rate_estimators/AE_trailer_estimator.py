...
class AETrailerRateEstimator():
    ...
    def AE_estimate(self, container_size, container_type, containers_count, cargo_weight_per_container, trip_type):
        ''' 
        Primary Function to estimate UAE's prices
        '''
        print("Estimating UAE's rates")
