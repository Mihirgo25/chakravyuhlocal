...
possible_direct_filters = ['id', 'feedback_type', 'performed_by_org_id', 'performed_by_id', 'status', 'closed_by_id', 'country_id', 'trade_type', 'service_provider_id', 'airport_id', 'serial_id', 'spot_search_serial_id']
