...
from services.air_customs_rate.air_customs_celery_worker import send_closed_notifications_to_sales_agent_air_customs_delay, delete_jobs_for_feedback_air_customs_rate_delay
...
def execute_transaction_code(request):
  ...
  for object in air_feedback_objects:
    ...
    delete_jobs_for_feedback_air_customs_rate_delay.apply_async(kwargs = {'requirements': request}, queue='critical')    
