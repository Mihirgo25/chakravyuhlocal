...
class FclCfsRateFeedback(BaseModel):
    ...
    preferred_cfs_rate = DoubleField(null=True)
    preferred_cfs_rate_currency = CharField(null=True)
    ...
    def send_closed_notifications_to_sales_agent(self):
        ...
        template_name = 'missing_cfs_rate_feedback_completed_notification' if 'rate_added' in closing_remarks else 'missing_cfs_rate_feedback_closed_notification'
        ...
        data = {
            ...
            'variables': {
                ...
                'remarks': remarks,
                'feedback_serial_id': self.serial_id,
    ...
    def send_notifications_to_supply_agents(self):
        ...
        data = {
            ...
            'template_name': 'missing_cfs_rate_feedback_notification',
            'variables': {
                'service_type': 'Fcl cfs',
