...
class HaulageFreightRateJob(BaseModel):
    ...
    def set_locations(self):
      ...
      obj = {'filters':{"id": ids}, 'includes': {'id': True, 'name': True, 'type': True, 'is_icd': True, 'cluster_id': True, 'city_id': True, 'country':True, 'country_id':True, 'country_code': True, 'display_name': True, 'default_params_required': True}}
