...
class HaulageFreightRateJobMapping(BaseModel):
    ...
    class Meta:
            table_name = 'haulage_freight_rate_job_mappings'

    def save(self, *args, **kwargs):
        self.updated_at = datetime.datetime.now()
        return super(HaulageFreightRateJobMapping, self).save(*args, **kwargs)