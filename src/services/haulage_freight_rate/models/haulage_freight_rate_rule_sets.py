...
class HaulageFreightRateRuleSet(BaseModel):
    ...
    weight_of_economy = FloatField(null=True)
    timeliness_constant = FloatField(null=True)
    environmental_protection_constant = FloatField(null=True)
    saftey_constant = FloatField(null=True)
    time_value_of_goods = FloatField(null=True)
    transportation_cost = FloatField(null=True)
    generalized_cost_environmental_protection = FloatField(null=True)
    basic_cost = FloatField(null=True)
    railway_construction_fund = FloatField(null=True)
    miscellaneous_charges = FloatField(null=True)
