...
def apply_similar_id_filter(query,filters):
    ...
    return query.where(HaulageFreightRateRequest.origin_port_id == rate_request_obj['origin_port_id'], HaulageFreightRateRequest.destination_port_id == rate_request_obj['destination_port_id'], HaulageFreightRateRequest.container_size == rate_request_obj['container_size'], HaulageFreightRateRequest.container_type == rate_request_obj['container_type'], HaulageFreightRateRequest.commodity == rate_request_obj['commodity'], HaulageFreightRateRequest.inco_term == rate_request_obj['inco_term'])
...
def apply_relevant_supply_agent_filter(query, filters):
    ...
    query = query.where((HaulageFreightRateRequest.origin_port_id << origin_port_id) | (HaulageFreightRateRequest.origin_country_id << origin_port_id) | (HaulageFreightRateRequest.origin_continent_id << origin_port_id) | (HaulageFreightRateRequest.origin_trade_id << origin_port_id))
    query = query.where((HaulageFreightRateRequest.destination_port_id << destination_port_id) | (HaulageFreightRateRequest.destination_country_id << destination_port_id) | (HaulageFreightRateRequest.destination_continent_id << destination_port_id) | (HaulageFreightRateRequest.destination_trade_id << destination_port_id))
    return query
