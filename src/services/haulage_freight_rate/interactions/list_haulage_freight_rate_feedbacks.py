...
possible_direct_filters = ['id', 'feedback_type','performed_by_id','status','closed_by_id','origin_location_id', 'destination_location_id', 'origin_country_id', 'destination_country_id', 'service_provider_id', 'serial_id', 'spot_search_serial_id','container_size','container_type','commodity','haulage_type','transport_mode']
