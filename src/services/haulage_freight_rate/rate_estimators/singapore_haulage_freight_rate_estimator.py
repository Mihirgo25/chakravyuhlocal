...
class SingaporeHaulageFreightRateEstimator:
    ...
    def estimate(self):
        ...
        """
        final_price = self.get_singapore_rates(
            query=self.query,
    ...
    def get_singapore_rates(
        ...
        final_data["base_price"] = self.apply_surcharges_for_singapore(indicative_price, container_size)
        final_data["currency"] = currency
        final_data["transit_time"] = transit_time
        return final_data

    def apply_surcharges_for_singapore(self, indicative_price, container_size):
