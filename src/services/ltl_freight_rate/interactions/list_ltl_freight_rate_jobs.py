...
def get_data(query, filters):
    ...
    for d in data:
        mappings_query = LtlFreightRateJobMapping.select(LtlFreightRateJobMapping.shipment_service_id ,LtlFreightRateJobMapping.source_serial_id, LtlFreightRateJobMapping.source_id, LtlFreightRateJobMapping.shipment_id, LtlFreightRateJobMapping.status).where(LtlFreightRateJobMapping.job_id == d['id'])
