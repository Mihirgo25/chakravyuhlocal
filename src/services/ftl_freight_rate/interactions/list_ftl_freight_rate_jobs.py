...
def get_data(query, filters):
    ...
    for d in data:
        mappings_query = FtlFreightRateJobMapping.select(FtlFreightRateJobMapping.shipment_serial_id, FtlFreightRateJobMapping.source_id, FtlFreightRateJobMapping.shipment_id, FtlFreightRateJobMapping.status).where(FtlFreightRateJobMapping.job_id == d['id'])
