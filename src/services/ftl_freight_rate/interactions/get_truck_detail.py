...
SELECTED_TRUCK_FIELDS = ['id', 'truck_company', 'truck_name', 'mileage', 'mileage_unit', 'capacity', 'capacity_unit', 'vehicle_weight', 'vehicle_weight_unit', 'fuel_type', 'no_of_wheels', 'country_id', 'truck_type', 'body_type', 'status']
