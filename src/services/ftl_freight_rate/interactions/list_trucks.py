...
POSSIBLE_INDIRECT_FILTERS = [
    "q",
    "capacity_greater_equal_than",
    "vehicle_weight_greater_equal_than",
]
TS_MATCH = "@@"
TS_FULL_MATCH = "<->"


def list_trucks_data(
    filters, page_limit=10, page=1, sort_by='updated_at', sort_type ='desc', pagination_data_required = False
):
    # make sql query
