...
from services.air_freight_rate.models.air_freight_rate_feedback import (
...
class PopulateAirFreightRateStatistics(MigrationHelpers):
                    ...
                    if (
                        ...
                        if not statistics:
                            ...
                            if not saved_status:
                                ...
                                self.populate_checkout_air_freight_statistics(
    ...
    def populate_checkout_air_freight_statistics(
        ...
        try:
            ...
            if params["shipment_id"]:
                try:
                    self.populate_shipment_stats_in_air_freight_stats(
    ...
    def populate_shipment_stats_in_air_freight_stats(
        ...
        try:
            with self.cogoback_connection.cursor() as cur:
                ...
                setattr(
                    statistic,
                    "packages_count",
                    statistic.packages_count + packages_count,
                )
