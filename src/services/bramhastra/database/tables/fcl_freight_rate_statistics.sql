...
CREATE TABLE brahmastra.kafka_rate_statistics
(
    `data` String
)
...
SELECT
    ...
    JSONExtractInt(data, 'before', 'identifier') AS identifier,
    ...
    JSONExtractString(data, 'before', 'validity_start') AS validity_start,
    JSONExtractString(data, 'before', 'validity_end') AS validity_end,
    ...
    JSONExtractString(data, 'before', 'origin_local_id') AS origin_local_id,
    JSONExtractString(data, 'before', 'destination_local_id') AS destination_local_id,
    ...
    JSONExtractString(data, 'before', 'origin_detention_id') AS origin_detention_id,
    JSONExtractString(data, 'before', 'destination_detention_id') AS destination_detention_id,
    JSONExtractString(data, 'before', 'origin_demurrage_id') AS origin_demurrage_id,
    JSONExtractString(data, 'before', 'destination_demurrage_id') AS destination_demurrage_id,
    JSONExtractString(data, 'before', 'cogo_entity_id') AS cogo_entity_id,
    ...
    JSONExtractString(data, 'before', 'parent_rate_id') AS parent_rate_id,
    JSONExtractString(data, 'before', 'parent_validity_id') AS parent_validity_id,
    ...
    JSONExtractString(data, 'before', 'rate_sheet_id') AS rate_sheet_id,
    JSONExtractString(data, 'before', 'bulk_operation_id') AS bulk_operation_id,
    ...
    JSONExtractFloat(data, 'before', 'tag') AS tag,
...
(
    ...
    JSONExtractInt(data, 'after', 'identifier') AS identifier,
    ...
    JSONExtractString(data, 'after', 'validity_start') AS validity_start,
    JSONExtractString(data, 'after', 'validity_end') AS validity_end,
    ...
    JSONExtractString(data, 'after', 'origin_local_id') AS origin_local_id,
    JSONExtractString(data, 'after', 'destination_local_id') AS destination_local_id,
    ...
    JSONExtractString(data, 'after', 'origin_detention_id') AS origin_detention_id,
    JSONExtractString(data, 'after', 'destination_detention_id') AS destination_detention_id,
    JSONExtractString(data, 'after', 'origin_demurrage_id') AS origin_demurrage_id,
    JSONExtractString(data, 'after', 'destination_demurrage_id') AS destination_demurrage_id,
    JSONExtractString(data, 'after', 'cogo_entity_id') AS cogo_entity_id,
    ...
    JSONExtractString(data, 'after', 'parent_rate_id') AS parent_rate_id,
    JSONExtractString(data, 'after', 'parent_validity_id') AS parent_validity_id,
    ...
    JSONExtractString(data, 'after', 'rate_sheet_id') AS rate_sheet_id,
    JSONExtractString(data, 'after', 'bulk_operation_id') AS bulk_operation_id,
    ...
    JSONExtractFloat(data, 'after', 'tag') AS tag,
