...
(
    ...
    `selected_air_freight_rate_statistic_id` UInt256,
...
SELECT
    ...
    toUUIDOrZero(JSONExtractString(data, 'before', 'spot_search_id')) AS spot_search_id,
    ...
    toUUIDOrZero(JSONExtractString(data, 'before', 'source_by_id')) AS source_by_id,
    ...
    toUUIDOrZero(JSONExtractString(data, 'before', 'spot_search_id')) AS spot_search_id,
    toUUIDOrZero(JSONExtractString(data, 'before', 'spot_search_air_freight_service_id')) AS spot_search_air_freight_service_id,
    ...
    arrayMap(x -> toUUIDOrZero(x),arrayMap(x->replaceRegexpAll(x,'"',''),JSONExtractArrayRaw(data,'before','rate_requested_ids'))) AS feedback_ids,
...
SELECT
    ...
    JSONExtractString(data, 'after', 'commodity_subtype') AS commodity_subtype,
    JSONExtractString(data, 'after', 'operation_type') AS operation_type,
    ...
    toUUIDOrZero(JSONExtractString(data, 'after', 'spot_search_id')) AS spot_search_id,
    ...
    toUUIDOrZero(JSONExtractString(data, 'after', 'source_by_id')) AS source_by_id,
    ...
    toUUIDOrZero(JSONExtractString(data, 'after', 'spot_search_id')) AS spot_search_id,
    toUUIDOrZero(JSONExtractString(data, 'after', 'spot_search_air_freight_service_id')) AS spot_search_air_freight_service_id,
    ...
    arrayMap(x -> toUUIDOrZero(x),arrayMap(x->replaceRegexpAll(x,'"',''),JSONExtractArrayRaw(data,'after','rate_requested_ids'))) AS feedback_ids,
    JSONExtractFloat(data, 'after', 'selected_standard_price') AS selected_standard_price,
    JSONExtractFloat(data, 'after', 'standard_price_accuracy') AS standard_price_accuracy,
    JSONExtractFloat(data, 'after', 'standard_price_diff_from_selected_rate') AS standard_price_diff_from_selected_rate,
    toUUIDOrZero(JSONExtractString(data, 'after', 'selected_air_freight_rate_statistic_id')) AS selected_air_freight_rate_statistic_id,
