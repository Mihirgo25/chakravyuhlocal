CREATE TABLE brahmastra.kafka_air_freight_actions
(
    `data` String
)
ENGINE = Kafka('127.0.0.1:29092', 'arc.public.air_freight_actions', '001','JSONAsString');

CREATE MATERIALIZED VIEW brahmastra.air_freight_before_actions TO brahmastra.air_freight_actions
(
    `id` UInt256,
...
JSONExtractInt(data, 'before', 'air_freight_rate_statistic_id') AS air_freight_rate_statistic_id,
...
JSONExtractString(data, 'before', 'spot_search_air_freight_service_id') AS spot_search_air_freight_service_id,
...
toUUIDOrZero(JSONExtractString(data, 'before', 'checkout_air_freight_service_id')) AS checkout_air_freight_service_id,
...
JSONExtractUInt(data, 'before', 'selected_air_freight_rate_statistic_id') AS selected_air_freight_rate_statistic_id,
...
-1 AS sign
FROM brahmastra.kafka_air_freight_actions
WHERE JSONExtractString(data, 'before') IS NOT NULL AND JSONExtract(data,'op','String') = 'u';

CREATE MATERIALIZED VIEW brahmastra.air_freight_after_actions TO brahmastra.air_freight_actions
(
    ...
    JSONExtractInt(data, 'after', 'air_freight_rate_statistic_id') AS air_freight_rate_statistic_id,
    ...
    JSONExtractString(data, 'after', 'spot_search_air_freight_service_id') AS spot_search_air_freight_service_id,
    ...
    toUUIDOrZero(JSONExtractString(data, 'after', 'checkout_air_freight_service_id')) AS checkout_air_freight_service_id,
    ...
    JSONExtractUInt(data, 'after', 'selected_air_freight_rate_statistic_id') AS selected_air_freight_rate_statistic_id,
