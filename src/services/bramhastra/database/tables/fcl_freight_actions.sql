...
(
    ...
    shipment_state Enum('default'=0,'received'=1,'confirmed_by_importer_exporter'=2,'cancelled'=3,'aborted'=4,'completed'=5),
    ...
    shipment_service_state Enum('default'=0,'containers_gated_out'=1,'containers_gated_in'=2,'cancelled'=3,'awaiting_service_provider_confirmation'=4,'confirmed_by_service_provider'=5,'vessel_arrived'=6,'vessel_departed'=7,'completed'=8,'aborted'=9,'init'=10),
    ...
    feedback_type Enum('default'=0,'disliked' = 1,'liked' = 2),
    feedback Enum('default'=0,'created' = 1,'closed' = 2 , 'rate_added' = 3),
    feedback_ids Array(UUID),
    rate_request Enum('default'=0,'created' = 1,'closed' = 2 , 'rate_added'=3),
