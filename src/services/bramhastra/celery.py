...
def fcl_daily_attributer_updater_in_delay(self):
    try:
        ...
        from services.bramhastra.workers.fcl_daily_attribute_updater_worker import (
            FclDailyAttributeUpdaterWorker,
        )
...
def send_fcl_rate_stats_in_delay(self, action, request, freight):
    from services.fcl_freight_rate.helpers.fcl_freight_statistics_helper import (
        send_rate_stats,
    )
...
def send_air_rate_stats_in_delay(self, action, request, freight):
    from services.air_freight_rate.helpers.air_freight_rate_statistic_helper import (
        send_rate_stats,
    )
