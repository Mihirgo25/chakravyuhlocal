...
def get_data(query, filters):
    ...
    for d in data:
        mappings_query = FclCustomsRateJobMapping.select(FclCustomsRateJobMapping.shipment_service_id, FclCustomsRateJobMapping.shipment_serial_id, FclCustomsRateJobMapping.source_id, FclCustomsRateJobMapping.shipment_id, FclCustomsRateJobMapping.status).where(FclCustomsRateJobMapping.job_id == d['id'])
