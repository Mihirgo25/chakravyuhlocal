...
CREATE TABLE default.kafka_actions
(
    `data` String
)

ENGINE = Kafka('127.0.0.1:29092', 'arc.public.#tabel', '001','JSONAsString')

CREATE MATERIALIZED VIEW default.fcl_before_actions TO default.stream_actions
...
JSONExtractDateTime(data, 'before', `validity_start`) AS validity_start,
JSONExtractDateTime(data, 'before', `validity_end`) AS validity_end,
...
JSONExtractDateTime(data, 'before', `checkout_created_at`) AS checkout_created_at,
...
JSONExtractDateTime(data, 'before', `shipment_created_at`) AS shipment_created_at,
JSONExtractDateTime(data, 'before', `shipment_updated_at`) AS shipment_updated_at,
...
JSONExtractDateTime(data, 'before', `shipment_service_created_at`) AS shipment_service_created_at,
JSONExtractDateTime(data, 'before', `shipment_service_updated_at`) AS shipment_service_updated_at,
...
JSONExtractEnum(data, 'before', `rate_request_state`) AS rate_request_state,
...
JSONExtractUInt256(data, 'before', `selected_fcl_freight_rate_statistic_id`) AS selected_fcl_freight_rate_statistic_id,
...
JSONExtractDateTime(data, 'before', `rate_created_at`) AS rate_created_at,
JSONExtractDateTime(data, 'before', `rate_updated_at`) AS rate_updated_at,
JSONExtractDateTime(data, 'before', `validity_created_at`) AS validity_created_at,
JSONExtractDateTime(data, 'before', `validity_updated_at`) AS validity_updated_at,
JSONExtractDateTime(data, 'before', `created_at`) AS created_at,
JSONExtractDateTime(data, 'before', `updated_at`) AS updated_at,
JSONExtractDateTime(data, 'before', `operation_created_at`) AS operation_created_at,
JSONExtractDateTime(data, 'before', `operation_updated_at`) AS operation_updated_at,

JSONExtractInt(data, 'source', `lsn`) AS version

    -1 AS sign

FROM default.kafka_actions

WHERE JSONExtract(data,'op','String') = 'u'

CREATE MATERIALIZED VIEW default.fcl_after_actions TO default.stream_actions
...
(
    ...
    JSONExtractDateTime(data, 'after', `validity_start`) AS validity_start,
    JSONExtractDateTime(data, 'after', `validity_end`) AS validity_end,
    ...
    JSONExtractDateTime(data, 'after', `checkout_created_at`) AS checkout_created_at,
    ...
    JSONExtractDateTime(data, 'after', `shipment_created_at`) AS shipment_created_at,
    JSONExtractDateTime(data, 'after', `shipment_updated_at`) AS shipment_updated_at,
    ...
    JSONExtractDateTime(data, 'after', `shipment_service_created_at`) AS shipment_service_created_at,
    JSONExtractDateTime(data, 'after', `shipment_service_updated_at`) AS shipment_service_updated_at,
    ...
    JSONExtractEnum(data, 'after', `rate_request_state`) AS rate_request_state,
    ...
    JSONExtractUInt256(data, 'after', `selected_fcl_freight_rate_statistic_id`) AS selected_fcl_freight_rate_statistic_id,
    ...
    JSONExtractDateTime(data, 'after', `rate_created_at`) AS rate_created_at,
    JSONExtractDateTime(data, 'after', `rate_updated_at`) AS rate_updated_at,
    JSONExtractDateTime(data, 'after', `validity_created_at`) AS validity_created_at,
    JSONExtractDateTime(data, 'after', `validity_updated_at`) AS validity_updated_at,
    JSONExtractDateTime(data, 'after', `created_at`) AS created_at,
    JSONExtractDateTime(data, 'after', `updated_at`) AS updated_at,
    JSONExtractDateTime(data, 'after', `operation_created_at`) AS operation_created_at,
    JSONExtractDateTime(data, 'after', `operation_updated_at`) AS operation_updated_at,
