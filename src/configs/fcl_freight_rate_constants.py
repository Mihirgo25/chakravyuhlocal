...
#     'standard' : GlobalConstants::STANDARD_COMMODITIES + GlobalConstants::HAZ_CLASSES,
#     'refer' : GlobalConstants::REFER_COMMODITIES,
#     'open_top' : GlobalConstants::OPEN_TOP_COMMODITIES,
#     'open_side' : GlobalConstants::OPEN_SIDE_COMMODITIES,
#     'flat_rack' : GlobalConstants::FLAT_RACK_COMMODITIES,
#     'iso_tank' : GlobalConstants::ISO_TANK_COMMODITIES + GlobalConstants::HAZ_CLASSES
# }

# LOCAL_CONTAINER_COMMODITY_MAPPINGS = {
#     'standard' :  None] + GlobalConstants::HAZ_CLASSES,
#     'refer' :  None],
#     'open_top' :  None],
#     'open_side' :  None],
#     'flat_rack' :  None],
#     'iso_tank' :  None] + GlobalConstants::HAZ_CLASSES
# }

# FREIGHT_CONTAINER_COMMODITY_MAPPINGS = {
#     'standard' : [GlobalConstants::FAK_COMMODITY] + GlobalConstants::STANDARD_COMMODITIES + GlobalConstants::HAZ_CLASSES,
#     'refer' : GlobalConstants::REFER_COMMODITIES,
#     'open_top' : GlobalConstants::OPEN_TOP_COMMODITIES,
#     'open_side' : [GlobalConstants::FAK_COMMODITY] + GlobalConstants::OPEN_SIDE_COMMODITIES,
#     'flat_rack' : GlobalConstants::FLAT_RACK_COMMODITIES,
#     'iso_tank' : GlobalConstants::ISO_TANK_COMMODITIES + GlobalConstants::HAZ_CLASSES
# }
