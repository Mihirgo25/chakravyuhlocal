...
def get_past_air_invoices(origin_location_id,destination_location_id,location_type, interval=1, interval_type = 'months', offset=0, limit=50):
        all_results =[]
        try:
            conn = get_connection()
            with conn:
                with conn.cursor() as cur:
                    ...
                    sql_query = """
                        ...
                        WHERE
                            ...
                            AND shipment_air_freight_services.destination_{}_id ='c298f645-7d0a-44cb-845f-da7d85ac0e16'
