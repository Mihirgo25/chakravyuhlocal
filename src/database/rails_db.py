...
def get_past_air_invoices(origin_location_id,destination_location_id,location_type, interval,interval_type='month', interval_types = 'months', offset=0, limit=50):
        all_results =[]
        try:
            conn = get_connection()
            with conn:
