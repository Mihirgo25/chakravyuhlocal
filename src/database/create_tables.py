    ...
    def create_tables(self, models):
        try:
            ...
            db.execute_sql(
              ...
              CREATE INDEX if not exists air_freight_rate_job_rate_type on air_freight_rate_jobs (rate_type);
              
              CREATE INDEX if not exists fcl_freight_rate_job_rate_type on fcl_freight_rate_jobs (rate_type);
