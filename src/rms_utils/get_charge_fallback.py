from configs.yml_definitions import FCL_FREIGHT_CHARGES,FCL_FREIGHT_LOCAL_CHARGES,FCL_FREIGHT_CURRENCIES,FCL_FREIGHT_SEASONAL_CHARGES,FCL_CFS_CHARGES,FCL_CUSTOMS_CHARGES,AIR_FREIGHT_CHARGES,AIR_FREIGHT_LOCAL_CHARGES,AIR_FREIGHT_SURCHARGES,AIR_FREIGHT_WAREHOUSE_CHARGES,AIR_FREIGHT_CURRENCIES,HAULAGE_FREIGHT_CHARGES,AIR_CUSTOMS_CHARGES
